  ...
  <>
    <div className={styles.grid}>
      <div className={styles.column}>
        <h1 className={styles.heading}>What is HonshouMieru?</h1>
        <p className={styles.text}>
          <span className={styles.keyword}>HonshouMieru</span> is an opinionated{' '}
      ...
      <div className={styles.column}>
        <h1 className={styles.heading}>Why HonshouMieru and not create-react-app?</h1>
        <p className={styles.text}>
          ...
          <br />
          <span className={styles.keyword}>HonshouMieru</span> is something a lot more
